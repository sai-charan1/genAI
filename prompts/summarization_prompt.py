# prompts/summarization_prompt.py
...
- Enforces per-chunk token limit: if text is long, either truncate after key factual
  sections or split/cluster into sub-summaries.
